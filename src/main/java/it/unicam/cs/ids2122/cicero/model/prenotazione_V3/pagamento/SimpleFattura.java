...
public class SimpleFattura implements Fattura {
     ...
     * @param valuta
     */
    public SimpleFattura( int id_prenotazione, int posti_prenotati, BigDecimal importo, String valuta){
