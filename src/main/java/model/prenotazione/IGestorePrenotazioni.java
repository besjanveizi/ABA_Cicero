...
public interface IGestorePrenotazioni<E extends IProprietaEsperienza> {
     ...
     */
    void aggiungiPrenotazione(ObjPrenotazione prenotazione);
     ...
     */
    List<IObjPrenotazione> recuperaEsperienzeAssociate();
     ...
     */
    IBuilderInterface modificaPrenotazione(IObjPrenotazione objPrenotazione);
