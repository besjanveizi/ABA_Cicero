...
public class ObjPrenotazione implements IObjPrenotazione {
    ...
    public ObjPrenotazione(String nome, int ID, int posti, boolean riserva, int tempoDiRiserva, LocalDateTime data_creazione, LocalDateTime ttl,float prezzo_singolo,float costo_totale,boolean invito){
        this.nome = nome;
        this.ID = ID;
        this.posti = posti;
    ...
    public ObjPrenotazione(BuilderPrenotazione b)  {
